const CACHE_NAME="gameday-crew-v2-shell-21";
const APP_SHELL=["./","./index.html","./styles.css","./brand.js","./app.js","./manifest.webmanifest","./logo.png","./icon-192.png","./icon-512.png"];
